				...
				<tbody>
						<%try{
							...
							while(rs.next()){
								...
								<td><%=packagecost %></td>
								<%
								Connection con1 = ConnectionString.getCon();
								...
								Connection con2 = ConnectionString.getCon();
								...
								Connection con3 = ConnectionString.getCon();
								...
								Connection con4 = ConnectionString.getCon();
